...
public class GojiBerryBushStage7Feature extends RandomPatchFeature {
	...
	public boolean place(FeaturePlaceContext<RandomPatchConfiguration> context) {
		...
		if (!GojiBerryBushAdditionalGenerationConditionProcedure.execute(world, x, y, z))
			return false;
