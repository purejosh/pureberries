...
public class BlueberryBushStage3Feature extends RandomPatchFeature {
	...
	public boolean place(FeaturePlaceContext<RandomPatchConfiguration> context) {
		...
		if (!BlueberryBushAdditionalGenerationConditionProcedure.execute(world, x, y, z))
			return false;
