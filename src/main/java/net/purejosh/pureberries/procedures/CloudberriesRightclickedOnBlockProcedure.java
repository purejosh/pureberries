...
public class CloudberriesRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == PureberriesModItems.CLOUDBERRIES
				|| (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == PureberriesModItems.CLOUDBERRIES) {
			if (((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.GRASS_BLOCK || (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.DIRT
				...
				world.setBlock(BlockPos.containing(x, y + 1, z), PureberriesModBlocks.CLOUDBERRY_PLANT_STAGE_0.defaultBlockState(), 3);
